...
def get_report_card(github):
    """Get a list of projects and grades per a student github"""
    ...
    print "Github: %s" % github
    for row in rows:
        print "Project: %s, Grade: %r" % (row[0], row[1])
